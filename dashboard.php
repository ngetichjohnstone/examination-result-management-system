                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">D.O.S Dashboard</h2>
...
?>
                                            ...
                                            <span class="name">Subjects Registered</span>
...
?>
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome to Students' Online Examination Results Tracking System!");
