                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    <li class="nav-header">
                                        <span class="">D.O.S Operations</span>
                                    </li>
                                    <li>
                                    ...
                                    <li class="nav-header">
                                        <span class="">Operation Category</span>
                                    </li>
...
<li class="has-children">
                                        ...
                                        <li><a href="change-password.php"><i class="fa fa fa-server"></i> <span> D.O.S Change Password</span></a></li>
