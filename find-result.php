                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Students' Online Examination Results Tracking System</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter Student's Roll ID</label>
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © 2022 SOERTS</small></p>
                    </div>
